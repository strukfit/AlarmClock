...
#include "AlarmClock/ToggleSwitch.h"
...
ToggleSwitch::ToggleSwitch(QWidget* parent, QString accentColor):
    QWidget{ parent },
...
void ToggleSwitch::paintEvent(QPaintEvent*)
{
    ...
    if (!isEnabled()) {
        ...
        painter.setPen(QColor(accentColor));
    else
        painter.setPen(QColor(outlineColor));

    if (m_checked)
        painter.setBrush(QColor(accentColor));
    ...
    if (m_checked) {
        ...
        painter.setBrush(QColor(outlineColor));
    }
